      ...
      <Container>
        <Content>
          ...
          <MyExperience>
            ...
            <p>
              Sou desenvolvedor Front-End da Dorper em que trabalhamos na stack
              de
            ...
            <div className="skills-list-container">
              <ul>
                ...
                <li>
                  Lido com bibliotecas externas que a aplicação necessite;
                </li>
                <li>
          ...
          <DorperInfo>
            ...
            <div className="dorper-info-content">
              <p>
                ...
                conhecimentos, habilidades e experiências através de
                videochamada de forma remunerada.{' '}
                <span>
